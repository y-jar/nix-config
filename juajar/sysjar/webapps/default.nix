...
# . ▀▀ : ╃
# -=-=-=-=-=-=-=-=-=-=-=
# goal: System-level webapps: declares sysset.webapps + autostart wiring.
# -=-=-=-=-=-=-=-=-=-=-=
        ...
        lib.types.submodule {
          options = {
            ...
            browser = lib.mkOption {
              ...
              default = null;
              description = "Which browser to launch. null = default (usrset.browsers.default / usrset.browsers.default); pwa/app default to chromium.";
            }; # end of browser
            icon = lib.mkOption {
