...
dirs=(
	...
	"art-jar/art-loom-jar/2d-jar"
	"art-jar/art-loom-jar/blender-loom-jar"
	"art-jar/book-jar"
	...
	"pic-jar/memes-jar/meme-mound-bin"
	"pic-jar/pers-bin"
	"pic-jar/pfp-bin"
	"pic-jar/scrtakes-jar/scr-mound-bin"
	"pic-jar/scrtakes-jar/valued-shots-bin"
	"pic-jar/wall-bin"
	"school-jar"
	"s-jar/config-jar"
	"s-jar/p-jar"
	"s-jar/vaults-jar"
	"vid-jar/dnld-mound-bin"
	"vid-jar/important-media-jar"
	"vid-jar/meme-mound-bin"
	"vid-jar/sub-10mb-bin"
	"vid-jar/vid-glaze-bin"
	"vid-jar/vid-loom-jar/mound-kiln-bin"
	"vid-jar/vid-loom-jar/vods-jar"
