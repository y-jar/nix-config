  ...
  config = lib.mkIf cfg.enable {
    programs.opencode = {
      ...
      extraPackages = with pkgs; [
        ...
        opencode-desktop # interface gui for opencode
      ...
      ''; # end of context
      # settings = { # ref: https://search.nixos.org/options?channel=26.05&query=opencode&source=home_manager&type=options#show=home-manager-option%253Aprograms.opencode.settings
      #   autoshare = false;
      #   autoupdate = true;
      # }; # end of settings
    }; # end of opencode
