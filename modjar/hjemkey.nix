...

{
  ...
  config = {
    ...
    hjem = {
      ...
      # [per-user dotfiles]
      # for each user in sysSettings.users, write:
      #   1. .profile (creates dirs + loads environment)
      #   2. All dotfiles from hjemDotfiles (generated by hjmbin modules)
      #
      # The hjemDotfiles options are set by modules in hjmbin/:
      #   shell/zsh.nix     --> hjemDotfiles.zshrc, .fzfrc
      #   git/default.nix    --> hjemDotfiles.gitconfig
      #   yazi/default.nix   --> hjemDotfiles.yaziToml, .yaziKeymap, .yaziTheme
      #   media/default.nix  --> hjemDotfiles.mpvConf
      #   niri/default.nix   --> hjemDotfiles.niriFiles
      #   directories/       --> hjemDotfiles.dirSetup
      #   resyoink/          --> hjemDotfiles.resYoink
      #
      # If an option is null, the dotfile is skipped (module disabled).
