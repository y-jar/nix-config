-- ref https://github.com/end-4/dots-hyprland/blob/main/dots/.config/hypr/hyprland/rules.lua
require("hl.shell-rules")
-- ######## Window rules ########
...
-- scrolling
hl.window_rule({ name = "foot_starting_width", match = { class = "foot" }, scrolling_width = 0.5 })
